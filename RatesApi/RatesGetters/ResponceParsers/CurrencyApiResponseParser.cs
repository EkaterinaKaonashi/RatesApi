...
{
    public class CurrencyApiResponseParser : IResponseParser
    {
        private readonly IMapper _mapper;
        private string _baseCurrency;
        private List<string> _currencies;
        public CurrencyApiResponseParser(string baseCurrency, List<string> currencies, IMapper mapper)
        {
            _mapper = mapper;
        ...
        public CurrencyApiResponseParser(IMapper mapper)
        {
            _mapper = mapper;
        }
        ...
        //public RatesExchangeModel ParseOpenExchangeRates(string content)
        //{
        //    var model = JsonConvert.DeserializeObject<CurrencyApiRatesModel>(content);
        //    var currensyPairs = new Dictionary<string, decimal>();
        //    var missingCurrencies = new List<string>();
